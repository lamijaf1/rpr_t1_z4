  ...
  public Predmet(String naziv, Student podaci){
    ...
    public  void upisi(Student student) throws IllegalArgumentException{
      ...
      for(int i=0;i<studenti.length;i++){
          if(student.getIme()==studenti[i].getIme()&& student.getPrezime()==studenti[i].getPrezime()&& student.getIndeks()==studenti[i].getIndeks())ima=true;
      }
      if(ima==true)throw new IllegalArgumentException("Pokusavate upisati vec postojeceg studenta!");
      NapraviNovi(student);
    }
